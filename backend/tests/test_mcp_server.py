...
each one delegates to the matching TOOLS/product_tools.py function (the
actual filtering/comparison logic is tested directly in
...
def test_tool_delegates_to_the_matching_product_tool_function(tool_name, target, args):
