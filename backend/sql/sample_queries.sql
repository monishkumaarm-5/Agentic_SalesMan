...
--
-- Prerequisites:
--   1. Run sql/sample_data_products.sql to create and populate the
--      `products` table.
--   2. (Optional) Run sql/sample_data_300.sql for legacy phone/laptop/
--      headphone tables, then sql/migrate_to_products_table.sql to
--      merge them into `products`.
-- =====================================================================
